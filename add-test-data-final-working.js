...
async function addTestData() {
  ...
  try {
    ...
    // Add test materials with just title and teacher_id
    const materials = [
      {
        id: `mat-${Date.now()}-1`,
        teacher_id: teacherId,
    ...
    for (const material of materials) {
      await connection.execute(
        'INSERT INTO materials (id, teacher_id, title, created_at) VALUES (?, ?, ?, ?)',
        [material.id, material.teacher_id, material.title, material.created_at]
      );
