...
async function addTestData() {
  ...
  try {
    ...
    const assignments = [
      {
        ...
        teacher_id: teacherId, // Use teacher record ID, not user ID
        stage_id: stageId,
    ...
    const certificates = [
      {
        ...
        teacher_id: teacherId, // Use teacher record ID
        stage_id: stageId,
        grade: 'ممتاز',
    ...
    console.log('\n8️⃣ Adding Student Progress Log...');
